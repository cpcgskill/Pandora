...
train_dataset, test_dataset = generate_train_and_test_dataset(get_merge_custom_answer_dataset(), chunk_size=512)
...
def start():
    ...
    # 仅使用前10000个样本
    new_train_dataset = train_dataset.shuffle(keep_in_memory=True, seed=42).select(range(10000))
